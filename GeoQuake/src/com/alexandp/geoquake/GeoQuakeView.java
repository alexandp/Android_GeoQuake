...
public class GeoQuakeView extends SurfaceView implements SurfaceHolder.Callback{
	
	  private AccelerometerReaderThread reader_thread_;
	  private GeoQuakeViewThread view_thread_;
	...
	public GeoQuakeView(Context ctx, int period) {
	    super(ctx);
	  ...
	  public void surfaceCreated(SurfaceHolder holder) {
	    ...
	    view_thread_ = new GeoQuakeViewThread(ctx_, holder, filter_, axis_, period_);
