...
public class GeoQuakeDbAdapter {
	  public static final String KEY_TITLE = "title";
	  public static final String KEY_BODY = "body";
	  public static final String KEY_ROWID = "_id";
	  private static final String TAG = "GeoQuakeDbAdapter";
	  private DatabaseHelper db_helper_;
	  private SQLiteDatabase db_;
	  
	  private static final String DATABASE_CREATE =
	      "create table geoquake (_id integer primary key autoincrement, " +
	      "title text not null, body blob not null);";

	  private static final String DATABASE_NAME = "data";
	  private static final String DATABASE_TABLE = "geoquake";
	  private static final int DATABASE_VERSION = 2;

	  private static final GeoQuakeDbAdapter instance_ = new GeoQuakeDbAdapter();
	  
	  public static GeoQuakeDbAdapter getAdapter() {
	    return instance_;
	  }

	  public GeoQuakeDbAdapter open(Context ctx) throws SQLException {
	  ...
	  private static class DatabaseHelper extends SQLiteOpenHelper {
	    ...
	    public void onUpgrade(SQLiteDatabase db, int old_version, int new_version) {
	      ...
	      db.execSQL("DROP TABLE IF EXISTS geoquake");
	      onCreate(db);
	    }
	  }	  
}
